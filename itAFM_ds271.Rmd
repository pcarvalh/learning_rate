...
dataset_path <- "ds271_student_step_All_Data_820_2016_0406_072042.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (Main-KC7-split)'
response <- 'First Attempt'
opportunity <- 'Opportunity (Main-KC7-split)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (Main-KC7-split)'
