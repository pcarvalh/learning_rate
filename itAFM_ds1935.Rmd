...
dataset_path <- "ds1935_student_step_All_Data_3680_2017_0228_022507.txt"
...
prediction <- 'Predicted Error Rate (LFASearchBICModel1-PVfixed-models uploaded)'
...
df_redux <- df_redux[-which(is.na(df_redux$prediction)),]
```
