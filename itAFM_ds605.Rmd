...
dataset_path <- "ds605_student_step_All_Data_1865_2018_0823_223003.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (KTracedSkills-Concatenated)'
response <- 'First Attempt'
opportunity <- 'Opportunity (KTracedSkills-Concatenated)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (KTracedSkills-Concatenated)'
