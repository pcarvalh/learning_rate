...
dataset_path <- "ds372_student_step_All_Data_1182_2016_0405_140426.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (Default_corrected)'
response <- 'First Attempt'
opportunity <- 'Opportunity (Default_corrected)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (Default_corrected)'
...
#df_redux <- df_redux[-which(is.na(df_redux$opportunity)),]
```
