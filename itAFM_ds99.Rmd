...
library(data.table)
df <- fread("data/ds99_student_step_All_Data_211_2016_0423_082151.txt")
```
...
ggplot(data=sum_df_long[sum_df_long$time_opp<100], aes(x=time_opp, y=ErrorRate,shape = typeRate,colour = typeRate)) +
