...
dataset_path <- "ds567_student_step_All_Data_1816_2016_0419_093248.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (Default_reprType_topic)'
response <- 'First Attempt'
opportunity <- 'Opportunity (Default_reprType_topic)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (Default_reprType_topic)'
