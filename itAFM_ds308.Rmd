...
dataset_path <- "ds308_student_step_All_Data_926_2017_0224_013931.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (LFASearchModel1)'
response <- 'First Attempt'
opportunity <- 'Opportunity (LFASearchModel1)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (LFASearchModel1)'
