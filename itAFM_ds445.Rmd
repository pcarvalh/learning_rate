...
dataset_path <- "ds445_student_step_All_Data_1469_2016_0403_085520.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (LFA_AIC_Model0_v2)'
response <- 'First Attempt'
opportunity <- 'Opportunity (LFA_AIC_Model0_v2)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (LFA_AIC_Model0_v2)'
