...
dataset_path <- "ds392_student_step_All_Data_1310_2019_0802_022703.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (KTskills-Mcontext-single-sep-ind-areas)'
response <- 'First Attempt'
opportunity <- 'Opportunity (KTskills-Mcontext-single-sep-ind-areas)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (KTskills-Mcontext-single-sep-ind-areas)'
