...
dataset_path <- "ds565_student_step_All_Data_1791_2016_0418_132659.txt"
dataset <- strsplit(dataset_path,"_")[[1]][1]

kcm <- 'KC (Default_topic)'
response <- 'First Attempt'
opportunity <- 'Opportunity (Default_topic)'
individual <- 'Anon Student Id'
time <- 'First Transaction Time'
prediction <- 'Predicted Error Rate (Default_topic)'
